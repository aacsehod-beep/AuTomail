      ...
      <div className="login-page-card page-fade">
        <aside className="login-hero-panel">
          ...
          <div className="login-hero-copy">
            ...
            <h1>Send attendance and circular emails from one workspace.</h1>
            <p>
              Bulk Mail, Attendance Mail, templates, logs, and scheduling are all in one place for Aurora University staff.
            </p>
          </div>
